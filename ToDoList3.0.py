...
# Dlammers, 11/22/2022, completed add data to list function in Processor and IO
# Dlammers, 11/23/2022, Completed delete data from list in Processor and IO
...
try:
    ...
    print('There is currently no data saved to file.')
